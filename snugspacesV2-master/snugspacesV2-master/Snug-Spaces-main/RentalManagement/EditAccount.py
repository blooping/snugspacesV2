...
editAcc_frame = tk.Frame(root, bg="white")
editAcc_frame.place(x="225", y = "60")

editAcc_label = tk.Label(editAcc_frame, text = "Edit Account", bg = '#4b7cdc', fg = 'white', font = ('times new roman', 24, 'bold'))
editAcc_label.pack()
...
# Edit Account button
buttonEdit_frame = tk.Frame(root)
buttonEdit_frame.place(x=275, y=375)
buttonEdit_button = tk.Button(buttonEdit_frame, text='Confirm', fg='white', bg='#2c6fbc',
                             font=(("Times New Roman"), 14), width=8, command=on_button_click)
buttonEdit_button.pack()
